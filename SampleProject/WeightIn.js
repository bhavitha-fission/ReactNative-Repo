...
import Period_2A from './src/components/Period_2A';
      ...
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View style={{ backgroundColor: 'white' }}>
          ...
          <Modal style={[styles.modal]} position={"bottom"} ref={"modal1"}>
            <Period_A {...this.props} btnClickEvent={(e) => this.changeModal(e)} />
          </Modal>
          ...
          <Modal style={[styles.modal]} position={"bottom"} ref={"modal2a"}>
            <Period_2A {...this.props} btnClickEvent={this.navigateModal} />
          </Modal>
